...
export default function MyOrders({ route, navigation }) {
    ...
    const _retrieveData = async () => {
        ...
        setLoading(true);
        let url = "https://mestamal.com/mahmoud/api/custom/offers.php?user_token=" + user_token;
        try {
            fetch(url, {
                method: "GET",
            })
    ...
    const deleteOrder = async (id) => {
        try {
            fetch("https://mestamal.com/mahmoud/api/api.php/records/item_offers/" + id, {
                method: "DELETE",
                headers: {
                    Accept: "*/*",
    ...
    const updateOrder = async () => {
        ...
        {
        try {
            fetch("https://mestamal.com/mahmoud/api/api.php/records/item_offers/" + current_item, {
                method: "PUT",
                headers: {
                    Accept: "*/*",
                    "Content-type": "multipart/form-data;",
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        ...
                        onPress={() => navigation.navigate("OfferInfo",{
                            ...
                            <View style={{ width: "20%" }}>
                                <Image source={{ uri: "https://mestamal.com/uploads/" + item.ad.main_image }}
