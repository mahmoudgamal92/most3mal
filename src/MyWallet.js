...
export default function MyWallet({ route, navigation }) {
    ...
    const _retriveTransactions = async () => {
        ...
        fetch("https://mestamal.com/mahmoud/api/api.php/records/payment_process?filter=user_id,eq," + user_id, {
            method: "GET",
            headers: {
                Accept: "*/*",
                "Content-type": "multipart/form-data;",
    ...
    const orderWithdraw = async () => {
        const user_id = await AsyncStorage.getItem("user_id");
        let url = "https://mestamal.com/mahmoud/api/api.php/records/payment_process";
        ...
        try {
            fetch(url, {
                ...
                .then(json => {
                    setInputModal(false);
                    alert("تم تسجيل طلب سحب الرصيد , سيتم خصم الرصيد عند التحويل من الإدارة");
        ...
        <View style={styles.container}>
            ...
            <View
                ...
                <View style={{ marginVertical: 40, width: "100%", paddingHorizontal: 60 }}>
                    ...
                    <Text style={{ fontFamily: "Bold", fontSize: 40, color: "#FFF", textAlign: "center" }}>
                        {
            ...
            <View style={{
                ...
                <Text style={{ textAlign: "center", fontFamily: "Bold", width: "100%", marginBottom: 10 }}>
                    المعاملات المالية
                </Text>
                        ...
                        <TouchableOpacity
                            ...
                            <View style={{
                            ...
                            }}>
                                {
                                    item.payment_type == "deposite" ?
                                        <Image source={require('./../assets/deposite.png')}
                            ...
                            <View style={{
                                ...
                                <View style={{ flexDirection: "row", justifyContent: "space-around", width: "100%" }}>
                                    ...
                                    <Text style={{ fontFamily: "Bold", fontSize: 15, color: "#000" }}>
                                        {item.amount} ربال
                                    </Text>
                                </View>
