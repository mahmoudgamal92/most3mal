...
export default function HomePage({ route, navigation }) {
    ...
    const _retrieveData = async () => {
        setLoading(true);
        let url = "https://mestamal.com/api/departments";
        try {
            fetch(url, {
                method: "GET",
                headers: {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <View
                    ...
                    <TouchableOpacity
                        style={{ width: "20%", justifyContent: "center", alignItems: "flex-end" }}>
                    ...
                    <Carousel
                        ...
                        renderItem={({ item }) => (
                            <View style={{
                                ...
                                <Image source={{ uri: "https://mestamal.com/uploads/" + item.image }}
                                    imageStyle={{ borderRadius: 10, paddingHorizontal: 10 }}
                                    style={{
                                        width: "100%",
                                        height: 200,
                                        borderRadius: 10,
